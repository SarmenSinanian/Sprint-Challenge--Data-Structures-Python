...
# Fixed size buffer; once full, oldest element dequeued/overwritten by enqueueing newest element
class RingBuffer:
...
# Retrieve items from the buffer (Except Nonetype items)
    def get(self):
